"""This is a First person controller GUI based game using Python Ursina engine library which contains assests for a GUI based game
here is the link of the website https://www.ursinaengine.org/
